...
When greeting a returning student, briefly acknowledge what module they are working on and offer one probing question or angle to start. Always finish your turn with a question that invites the student to think further.`;
}
