      ...
      <Card>
        ...
        <CardContent className="prose prose-stone max-w-none">
          ...
          <p>
            ...
            4.5) speaks for the instructor, pushes back on weak arguments,
            and gives formative feedback — but it will never write your work
            for you.
          </p>
        </CardContent>
      </Card>
      ...
      {student && (
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Textarea
              rows={5}
              placeholder="I'm a sophomore studying biology, and I've always wondered…"
